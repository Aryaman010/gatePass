...
public class securitycheckApprovedRequests extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_check_approved_requests);

        RecyclerView recyclerView = findViewById(R.id.recyclerSecurityNewEntries);
        ...
        myRef.addValueEventListener(new ValueEventListener() {
            ...
            public void onDataChange(@NonNull DataSnapshot snapshot) {
                ...
                recyclerView.setAdapter(new securityMyAdapter(getApplicationContext(),items));

...
public class aimlPreviousActivity extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_aiml_previous);

        RecyclerView recyclerView = findViewById(R.id.recyclerPreviousEntries);

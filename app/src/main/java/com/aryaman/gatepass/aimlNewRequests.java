...
public class aimlNewRequests extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_aiml_new_requests);
        RecyclerView recyclerView = findViewById(R.id.recyclerNewEntries);
